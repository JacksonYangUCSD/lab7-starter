...
class RecipeCard extends HTMLElement {
	...
	set data(data) {
        ...
        <div class="rating">
            ${this.generateRatingStars(data.rating)}
	...
	generateRatingStars(rating) {
        let starsHtml = '';
		if (rating === 0){
			return starsHtml += `<img src="assets/images/icons/0-star.svg" star"></img>`
		}
        for (let i = 0; i < rating; i++) {
            starsHtml = `<img src="assets/images/icons/${i+1}-star.svg" star"></img>`;
        }
        return starsHtml;
	}
}
